...
// Aligned with Copilot's prompt/common/codeGuesser.ts

import { isBasicASCII } from '../../../../../base/common/strings.js';

export function quizLooksLikeCode(text: string): boolean {
