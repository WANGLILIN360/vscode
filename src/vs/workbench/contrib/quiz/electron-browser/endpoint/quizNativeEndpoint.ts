 ...
 */
export class QuizNativeEndpoint implements IQuizEndpoint {
	...
	readonly modelId = 'native-stub';
	readonly name = 'native-stub-endpoint';
	readonly version = '0';
	readonly family = '';
	...
	async *sendChatRequest(
		...
		this._logService.info(`[QuizNativeEndpoint] Sending request with ${messages.length} messages via Node.js`);

		// TODO: Replace with actual Node.js HTTP implementation
		yield { text: '[Native endpoint stub - replace with real implementation]', finishReason: 'stop' };
	}
