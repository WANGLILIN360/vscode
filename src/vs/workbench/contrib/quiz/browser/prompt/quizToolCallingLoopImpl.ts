...
// Layer: browser — DI-injected implementation of QuizDefaultToolCallingLoop.
// Moved from common/ to comply with the four-layer architecture rules.
// The implementation class uses @ILogService, @IQuizChatHookService, @IQuizSessionTranscriptService
...
import { IQuizChatRequestOptions, IQuizTokenUsage } from '../../common/endpoint/quizEndpoint.js';
import { IQuizToolsService, IQuizToolInvocationContext } from '../../common/tools/quizToolsService.js';
import { QuizToolCallRoundImpl } from '../../common/prompt/quizConversation.js';
import {
...
} from '../../common/prompt/quizHookService.js';
import { IQuizSessionTranscriptService } from '../../common/prompt/quizSessionTranscript.js';
import {
	IQuizToolCallingLoopOptions,
	IQuizToolCallSingleResult,
	IQuizFetchResult,
	QuizFetchResponseType,
	QuizToolCallLimitBehavior,
	IQuizStartHookResult,
	IQuizStopHookResult,
	IQuizSubagentStartHookResult,
	IQuizSubagentStopHookResult,
	formatQuizHookContext,
} from '../../common/prompt/quizToolCallingLoop.js';
...
export class QuizDefaultToolCallingLoop extends Disposable {
	...
	public async runStartHooks(outputStream: IQuizResponseStream | undefined, token: CancellationToken): Promise<void> {
		...
		const hasHooks = this._options.hasHooksEnable ?? false;
